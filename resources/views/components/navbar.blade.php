        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-nav-link href="{{ route('posts') }}" :active="request()->is('posts')">Blog</x-nav-link>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Fikri Akbar Pratama</div>
            <div class="text-sm font-medium text-gray-400">fikri.akbar1p@gmail.com</div>
          </div>
        </div>
